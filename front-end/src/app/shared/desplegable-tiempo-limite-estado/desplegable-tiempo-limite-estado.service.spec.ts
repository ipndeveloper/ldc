...
describe('DesplegableTiempoLimiteEstadoService', () => {
  let apiService: any;
  let service: DesplegableTiempoLimiteEstadoService;

  configureTestSuite(() => {
    apiService = jasmine.createSpyObj('ApiService', ['get']);
    TestBed.configureTestingModule({
      imports: [TestModule],
      providers: [ DesplegableTiempoLimiteEstadoService,
      {provide: ApiService, useValue: apiService}]
    });
    service = TestBed.get(DesplegableTiempoLimiteEstadoService);
  });
  ...
  describe('El metodo getAll()', () => {
    it('invoca al metodo get del ApiService', () => {
      ...
      expect(apiService.get).toHaveBeenCalledWith('tiempo-limite-estado');
