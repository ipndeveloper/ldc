...
describe('DesplegableTipoSobreTransporteService', () => {
  let apiService: any;
  let service: DesplegableTipoSobreTransporteService;
  ...
  configureTestSuite(() => {
    ...
    service = TestBed.get(DesplegableTipoSobreTransporteService);
  });
  ...
  describe('El metodo getAll()', () => {
    it('invoca al metodo get del ApiService', () => {
      ...
      expect(apiService.get).toHaveBeenCalledWith('tipo-sobre-transporte');
